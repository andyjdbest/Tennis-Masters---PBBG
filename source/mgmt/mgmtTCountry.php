...
$GLOBALS['allowedFileTypes'] = array("image/gif", "text/html", "text/plain", "application/pdf", "application/x-pdf", "application/x-lyx", "application/msword", "application/msexcel", "application/msaccess", "text/richtxt", "application/mspowerpoint", "application/octet-stream", "application/x-zip-compressed","application/vnd.ms-powerpoint");
